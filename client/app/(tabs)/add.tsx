...
export default function AddTransaction() {
  ...
  const loadTags = async () => {
    ...
    const res = await fetch(`http://10.0.2.2:8000/tags/${activeTab}`, {
  ...
  const updateTag = async () => {
    ...
    try {
      ...
      const res = await fetch(`http://10.0.2.2:8000/tags/${editingTag._id}`, {
        method: "PUT",
        headers: {
  ...
  const deleteTag = async (id: string) => {
    ...
    await fetch(`http://10.0.2.2:8000/tags/${id}`, {
      method: "DELETE",
      headers: {
        Authorization: `Bearer ${token}`,
      },
  ...
  const handleSave = async () => {
    ...
    if (isEdit) {
      res = await fetch(`http://10.0.2.2:8000/transactions/${editData._id}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
      ...
      res = await fetch(`http://10.0.2.2:8000/transactions`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
          ...
          <View className="w-[85%] p-5 rounded-2xl" style={{ backgroundColor: theme.card }}>
            ...
            <TouchableOpacity
              ...
              onPress={async () => {
                ...
                const res = await fetch(`http://10.0.2.2:8000/tags`, {
                  method: "POST",
                  headers: {
                    "Content-Type": "application/json",
                    Authorization: `Bearer ${token}`
